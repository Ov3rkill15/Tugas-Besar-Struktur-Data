...
# Dokumentasi Sistem Lowongan Kerja

Berikut adalah alur kerja (flowchart) dari aplikasi, mulai dari inisialisasi sistem, login, hingga pembagian hak akses user (Mahasiswa, Dosen, Perusahaan, Admin).
...
graph TD
    ...
    Init["Initialize Data Structures<br/>(ListParent, ListChild, Users)"]
    ...
    subgraph Login_System [Login System]
        ...
        Auth{Authenticate?}
        RegisterAction["Add to Users Array<br/>(Default: Mahasiswa)"]
        CheckExit{Exit?}
    end
